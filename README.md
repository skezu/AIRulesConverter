...
**aix** is a VS Code extension and standalone CLI tool designed to streamline the management of AI coding rules. It allows you to easily convert rule definitions between various AI-assisted IDE and CLI formats, ensuring your coding standards are consistent across all your tools.
...
npx aix migrate --from cursor --to agy --dry-run
...
npx aix convert-plugin --plugin caveman --from antigravity --to claude-code --out ./out

# List all supported formats
npx aix list-formats
```
...
| 1.3.0 | Claude Code, Gemini CLI, GitHub Copilot support. Standalone CLI (`npx aix`). Platform-agnostic core refactor. |
